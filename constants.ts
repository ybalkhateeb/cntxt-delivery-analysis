...
export const OPPORTUNITIES: Opportunity[] = [
  {
    ...
    issue: 'Delivery - High Pricing',
    notes: 'Initial Delivery cost $138k. Reduced to $93k. Partner quoted $58k and was approved.',
    isHighPriority: true,
  ...
  },
  {
    ...
    partnerName: null,
    issue: 'Delivery - High Pricing',
    notes: 'Client not satisfied with pricing, currently looking for alternatives. Cloud Foundational Large Package.',
    isHighPriority: true,
  ...
  },
  {
    ...
    partnerName: null,
    issue: 'Prices',
    notes: 'Client postponed to next year. Delivery picked Workloads Migration - Small Package.',
    isHighPriority: true,
  ...
  },
  {
    ...
    issue: 'Delivery - High Pricing',
    notes: 'Delivery picked for landing zone only. Delivery significantly higher than SBM ($35k) and Omniops ($29.5k).',
    isHighPriority: true,
  ...
  },
  {
    ...
    issue: 'Delivery - High Pricing',
    notes: 'Initial quote 50M SAR. Reduced to 28M SAR by bringing in partner. High pricing flag.',
    isHighPriority: true,
  ...
  },
  {
    ...
    partnerName: 'Partner',
    issue: 'Delivery - High Pricing',
    notes: 'Proposed along with partner augmenting 24 months work.',
    isHighPriority: true,
  ...
  },
  {
    ...
    partnerName: null,
    issue: 'Delivery - High Pricing',
    notes: 'Effort estimated to cost over $1 million for 1 year of work.',
    isHighPriority: true,
  ...
  },
  {
    ...
    partnerName: null,
    issue: null,
    notes: 'Customer wants to use it.',
  ...
  },
  {
    ...
    issue: 'Other',
    notes: 'Lost to our delivery but won for rackspace.',
    isHighPriority: false,
  ...
  },
  {
    ...
    partnerName: null,
    issue: 'Pricing',
    notes: 'Response to RFP, small landing zone was picked.',
    isHighPriority: false,
  ...
  },
  {
    ...
    partnerName: null,
    issue: 'Process',
    notes: 'Presales didn\'t do requirement gathering because sales approached delivery first. Works only if delivery proposal is accepted.',
    isHighPriority: true,
    useCase: 'Requirements gathering skipped by sales. Scope undefined.',
    deliveryEffort: 'N/A',
    partnerEffort: 'N/A',
  }
];
